...
# ---------- RTSP / Modelo ----------
RTSP_URL = "rtsp://admin:111229@192.168.1.2:554/cam/realmonitor?channel=1&subtype=1"
...
class PeopleCounter:
    ...
    def run(self):
        ...
        print("  ✓ Flags anti-duplicação por ID (has_entrada / has_saida)")  # NOVO
        print("  ✓ Penalidade leve quando IoU<0.08 para reduzir swap de IDs") # NOVO
        print("=" * 60)
        ...
        while True:
            if not paused:
                ...
                dt = time.time() - t0
                if dt > 0:
                    self.fps_counter.append(1.0 / dt)
